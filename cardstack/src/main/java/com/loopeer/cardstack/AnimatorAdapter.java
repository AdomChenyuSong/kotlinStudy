...
public abstract class AnimatorAdapter {
    ...
    public void itemClick(final CardStackView.ViewHolder viewHolder, int position) {
        ...
        if (mCardStackView.getSelectPosition() == position) {
            onItemCollapse(viewHolder,position);
        } else {
    ...
    private void onItemExpand(final CardStackView.ViewHolder viewHolder, final int position) {
        ...
        if (preSelectViewHolder != null) {
            preSelectViewHolder.onItemExpand(false,position);
        }
        ...
        mSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                viewHolder.onItemExpand(true,position);
                if (preSelectViewHolder != null) {
    ...
    private void onItemCollapse(final CardStackView.ViewHolder viewHolder, final int position) {
        ...
        mSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
                viewHolder.onItemExpand(false,position);
